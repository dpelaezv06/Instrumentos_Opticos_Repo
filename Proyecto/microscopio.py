...
diametro_Diafragma = 6.1E-3 #diametro de la pupila del objetivo de microscopio
...
filtro = opt.funcion_Circulo(0.3E-3, None, malla_XlenteAnteriorDemagnificador, malla_YlenteAnteriorDemagnificador)
...
patron_DMD = tamano_fisicoDMD
#opt.rejilla_difraccion(ancho_franjaEspejos, malla_XpatronDMD, malla_YpatronDMD, 90) * tamano_fisicoDMD
...
plt.imsave('uniforme_simulado.png', modulo_cuadradoSensor, cmap = 'gray')

...
muestreo_Objeto = opt.muestreo_SegunSensorFresnel(pixeles_X, ancho_XVentanaDiafragma, propiedad_SistemaAnterior["matriz_Sistema"][0,1], longitud_Onda, pixeles_Y, ancho_XVentanaDiafragma)
...
filtro = opt.funcion_Rectangulo(lado, lado, [-4.6E-4, 1.08E-4], malla_XDiafragma, malla_YDiafragma)
filtro |= opt.funcion_Rectangulo(lado, lado, [-1.53E-4, 1.2E-4],malla_XDiafragma,malla_YDiafragma)
filtro |= opt.funcion_Rectangulo(lado, lado, [1.57E-4, 9.5E-5],malla_XDiafragma,malla_YDiafragma)
filtro |= opt.funcion_Rectangulo(lado, lado, [4.64E-4, 9.7E-5],malla_XDiafragma,malla_YDiafragma)
filtro |= opt.funcion_Rectangulo(lado, lado, [-1.51E-4, -8.9E-5],malla_XDiafragma,malla_YDiafragma)
filtro |= opt.funcion_Rectangulo(lado, lado, [1.59E-4, -1.113E-4],malla_XDiafragma,malla_YDiafragma)
filtro |= opt.funcion_Rectangulo(lado, lado, [4.66E-4, -9.8E-5],malla_XDiafragma,malla_YDiafragma)
filtro = opt.invertir_Array(filtro)
campo_AnteriorDiafragma = campo_Anterior * filtro * diafragma_Campo
